...
describe("Attack", function () {
  it("Should be able to read the private variables pasword and username", async () => {
    ...
    console.log(
      "This is the slot0Bytes:",
      ethers.utils.parseBytes32String(slot0Bytes)
    );

    // We are able to extract the valuer of the private variables
